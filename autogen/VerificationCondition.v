...
Definition Pbsqrtsd_bp code : bool :=
	...
	let bresult0 := b["000011110101000111000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmovsq_rm_bp code : bool :=
	...
	let bresult0 := b["0000111101111110"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmovsq_mr_bp code : bool :=
	let blen := 16 <=? (length code) in
	let bmask0 := b["1111111111111111"] in
	let bresult0 := b["0000111111010110"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pminsd_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101110111000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmaxsd_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101111111000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pdivss_d_ff_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101111011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmuls_d_ff_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101100111000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Psubs_d_ff_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101110011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pandps_d_fm_bp code : bool :=
	let blen := 16 <=? (length code) in
	let bmask0 := b["1111111111111111"] in
	let bresult0 := b["0000111101010100"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Padds_d_ff_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101100011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Prolw_ri_bp code : bool :=
	let blen := 16 <=? (length code) in
	let bmask0 := b["1111111111111000"] in
	let bresult0 := b["1100000111000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pcvtsi2ss_d_fr_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110010101011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pcvttss_d_2si_rf_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110010110011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pcvtsd2ss_d_ff_bp code : bool :=
	let blen := 24 <=? (length code) in
	let bmask0 := b["111111111111111111000000"] in
	let bresult0 := b["000011110101101011000000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmovss_d_fm_bp code : bool :=
	let blen := 16 <=? (length code) in
	let bmask0 := b["1111111111111111"] in
	let bresult0 := b["0000111100010000"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
...
Definition Pmovss_d_mf_bp code : bool :=
	let blen := 16 <=? (length code) in
	let bmask0 := b["1111111111111111"] in
	let bresult0 := b["0000111100010001"] in
	let bmatch0 := bp_eq(bp_and bmask0 code) bresult0 in
	true && blen && bmatch0.
