...
(* Lcall *)
  left; econstructor; split.
  econstructor. eapply functions_translated; eauto. eauto.
...
Theorem transf_program_correct prog tprog fn_stack_requirements:
  ...
  forward_simulation cc_id cc_id (Linear.semantics fn_stack_requirements prog) (Linear.semantics fn_stack_requirements tprog).
Proof.
