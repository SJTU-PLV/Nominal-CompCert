...
Inductive match_states: state -> state -> Prop :=
  ...
  | match_states_call:
      forall s vf vf' args m s' args' m' id
             (STACKS: match_stackframes s s')
...
- (* Icall *)
  ...
  apply ros_address_translated with (ros:=ros) in RLD as FLD.
  subst vf. rewrite H0 in FLD. inv FLD. eauto.
