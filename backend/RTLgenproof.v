...
(* Exec *)
  ...
  apply Genv.genv_vars_eq in H as H''. subst.
  eapply star_left. eapply exec_Icall; eauto.
  cbn. unfold Genv.symbol_address. cbn in H. rewrite H. eauto.
  cbn. unfold Genv.symbol_address. cbn in H. rewrite H. eauto.
  eauto.
...
Proof.
  ...
  eapply exec_Icall; eauto. simpl. unfold Genv.symbol_address.
  cbn in H5. rewrite H5. eauto.
  cbn.  unfold Genv.symbol_address.  cbn in H5. rewrite H5. eauto.
  apply sig_transl_function; auto.
  traceEq.
  ...
  cbn in H7. rewrite H7. eauto.
  cbn.  unfold Genv.symbol_address.
  cbn in H7. rewrite H7. eauto.
  apply sig_transl_function; auto.
  rewrite H; eauto.
  traceEq.
  apply Genv.genv_vars_eq in H7 as H9. inv H9.
  constructor; auto.
...
Proof.
  ...
  monadInv B.
  econstructor; split.
  - econstructor; eauto. inv H5. reflexivity.
  - econstructor; eauto. constructor.
Qed.
