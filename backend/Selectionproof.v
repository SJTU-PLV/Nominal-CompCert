...
Definition eventually := Smallstep.eventually (Cminor.step fn_stack_requirements) Cminor.final_state ge.
...
- intros S1 t S2 A T1 (M & W1).
  assert (W2: wt_state S2). eapply subject_reduction; eauto using wt_prog.
  apply A.
...
+ right; exists n, T2; split.
  ...
  intros. eapply subject_reduction; eauto using wt_prog. apply H.
Qed.
