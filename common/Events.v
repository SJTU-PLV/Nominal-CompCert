...
(** External calls do not change support. *)
  ec_mem_support:
    forall ge vargs m t vres m',
    sem ge vargs m t vres m' -> Mem.support m' = Mem.support m;
...
- inv H; inv H0; simpl; lia.
(* support *)
- inv H; inv H0; auto. eapply Mem.support_store; eauto.
(* receptive *)
...
- inv H; simpl; lia.
(* support *)
- inv H; simpl; auto. erewrite Mem.support_free; eauto.
(* receptive *)
...
Definition external_call_support ef := ec_mem_support (external_call_spec ef).
...
(* the external_call here is all the external functions except the real
   module interaction *)
(*
...
Proof.
  intros. exploit external_call_support; eauto.
  intro.
  unfold Mem.sdepth. congruence.
Qed.
...
Proof.
  ...
  apply external_call_support in H3.
  congruence.
Qed.
