...
Proof.
  induction l1. left. intros. inv H.
...
Proof.
  destruct s1 as [st1 g1]. destruct s2 as [st2 g2].
  destruct (global_include_dec g1 g2).
  destruct (stree_include_dec st1 st2).
  - left. unfold sup_include. intro. destruct b; simpl; eauto.
  - right. unfold sup_include. intro. apply n.
    unfold stree_include.
    intros. generalize (H (Stack fid p pos)).
    simpl. eauto.
  - right. unfold sup_include. intro. apply n.
    intros. generalize (H (Global i)).
    simpl. eauto.
Qed.
