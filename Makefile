...
DIRS := lib common $(ARCHDIRS) backend cfrontend driver export cparser cklr demo close concur cdemo
...
FILES=$(VLIB) $(COMMON) $(CKLR) $(BACKEND) $(CFRONTEND) $(CLOSE) $(CONCUR) $(DRIVER) $(DEMO) $(CDEMO) $(FLOCQ) \
