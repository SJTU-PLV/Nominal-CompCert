...
DIRS := lib common $(ARCHDIRS) backend cfrontend driver export cparser cklr demo unusedglob
...
UNUSEDGLOB = Callconv.v ForwardSim.v Unusedglob.v Unusedglobproof.v \
         HoriComp.v VerComp.v InjectComp1.v  InjectComp2.v
...
FILES=$(VLIB) $(COMMON) $(CKLR) $(BACKEND) $(CFRONTEND) $(DRIVER) $(DEMO) $(UNUSEDGLOB) \
  $(FLOCQ) $(MENHIRLIB) $(PARSER) $(EXPORTLIB)
