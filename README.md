...
[assembler/RelocBingen.v](assembler/RelocBingen.v) by importing the
`TranslateInstr.v` module. It works because both implementation in x86
and riscV has the same name.
