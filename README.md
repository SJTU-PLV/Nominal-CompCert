...
is slower than GCC. We conjecture that it is because the GNU assembler
performs optimization in the generated object files, e.g., by merging
the sections, using compressed instructions, or using peephole
optimization. 
